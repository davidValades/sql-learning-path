...
Muestra: `avion`, `capacidad_pasajeros`, `anio_fabricacion`, `ruta`, `distancia_km`, `fecha_salida`, `estado_flota` (`'En servicio'` / `'Disponible'`). Ordena por avión y fecha.
...
ORDER BY a.modelo, v.fecha_salida;
```

Resultado:
| avion | capacidad_pasajeros | anio_fabricacion | ruta | distancia_km | fecha_salida | estado_flota |
|-------|-----------|-----------------|------|-------------|-------------|-------------|
...
Muestra: `avion`, `capacidad_pasajeros`, `num_vuelos`, `distancia_total_km`, `infrautilizado` (`'Sí'` / `'No'`).
...
Resultado:
| avion | capacidad_pasajeros | num_vuelos | distancia_total_km | infrautilizado |
|-------|-----------|-----------|-------------------|----------------|
